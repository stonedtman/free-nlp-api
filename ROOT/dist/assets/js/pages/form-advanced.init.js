! function(o) {
	...
	t.prototype.initCustomSelect = function() {
		...
		o("#basic-colorpicker").colorpicker(), o("#hexa-colorpicker").colorpicker({
			format: "auto"
		}), o("#component-colorpicker").colorpicker({
			format: null
		}), o("#horizontal-colorpicker").colorpicker({
			horizontal: !0
		...
		this.initCustomSelect(), this.initMultiSelect(), this.initFlatpickr(), this.initColorpicker(), this
			.initTouchspin()
