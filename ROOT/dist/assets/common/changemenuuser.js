...
function jump(path, name, parentname) {
  ...
  if (name == "用户信息") {
    path = "/dist/assets/usercenter/index.html";
  }
  var parentMenuItem = "";
  ...
  if (path) {
    if (name == "用户信息") {
      $("#main").load("/dist/assets/usercenter/userinfo/index.html");
    } else {
      $("#main").load(path);
    }
  }
...
var urlList = [
  {
    url: "/dist/assets/usercenter/index.html",
    name: "用户信息",
    parentname: "",
  },
  {
    url: "/dist/assets/usercenter/usequotas/index.html",
    name: "使用配额",
    parentname: "",
  },
  {
    url: "/dist/assets/usercenter/callstatistics/index.html",
    name: "调用统计",
    parentname: "",
  },
];
