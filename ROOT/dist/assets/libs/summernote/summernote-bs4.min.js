...
!(function (t, e) {
      ...
      return (
        (t.prototype.render = function (t) {
          ...
          if (
            ...
            this.options &&
              this.options.data &&
              C.each(this.options.data, function (t, e) {
                o.attr("data-" + t, e);
              }),
            this.options &&
              this.options.click &&
            ...
            [
              ...
              e.title
                ? '    <div class="modal-header">      <h4 class="modal-title">' +
                  e.title +
                  '</h4>      <button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true"><i class="uil uil-multiply" style="font-size: 18px;"></i></button>    </div>'
                : "",
  ...
  (C.summernote = C.summernote || { lang: {} }),
  ...
  if (x) {
    ...
    S && (k = parseFloat(S[1])),
      (S = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(w)) &&
        (k = parseFloat(S[1]));
  }
  var I = /Edge\/\d+/.test(w),
    T = !!window.CodeMirror,
  ...
  var V = O("TABLE"),
    G = O("DATA");
  function _(t) {
    return !(X(t) || Z(t) || Y(t) || K(t) || V(t) || J(t) || G(t));
  }
  function Z(t) {
  ...
  function it(t) {
    ...
    return (
      0 === e ||
      (!U(t) && 1 === e && t.innerHTML === ot) ||
      !(!B.all(t.childNodes, U) || "" !== t.innerHTML)
    );
  }
  function rt(t) {
  ...
  function Ct(t, e) {
    ...
    return (
      dt(s, lt(r)),
      o || (rt(t.node), rt(s)),
      i && (it(t.node) && St(t.node), it(s)) ? (St(s), t.node.nextSibling) : s
    );
  }
  function wt(t, o, n) {
    ...
    return e.length
      ? 1 === e.length
        ...
        : e.reduce(function (t, e) {
            return (
              t === o.node && (t = Ct(o, n)),
              Ct({ node: e, offset: t ? gt(t) : nt(e) }, n)
            );
          })
      : null;
  }
  ...
  var $t = {
      ...
      splitPoint: function (t, e) {
        ...
        var a =
          o && wt(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
        return (
    ...
    Nt = (function () {
      ...
      return (
        ...
        (t.prototype.initializeModule = function (t) {
          ...
          (e.shouldInitialize = e.shouldInitialize || A.ok),
            e.shouldInitialize() &&
              (e.initialize && e.initialize(),
              e.events && $t.attachEvents(this.$note, e.events));
        }),
        ...
        (t.prototype.removeModule = function (t) {
          var e = this.modules[t];
          e.shouldInitialize() &&
            (e.events && $t.detachEvents(this.$note, e.events),
            e.destroy && e.destroy()),
  ...
  C.fn.extend({
    summernote: function () {
      ...
      (i.langInfo = C.extend(
        !0,
        {},
        C.summernote.lang["en-US"],
        C.summernote.lang[i.lang]
      )),
        (i.icons = C.extend(!0, {}, C.summernote.options.icons, i.icons)),
        (i.tooltip = "auto" === i.tooltip ? !R.isSupportTouch : i.tooltip),
  ...
  var Lt = (function () {
      function r(t, e, o, n) {
        (this.sc = t),
          ...
          (this.ec = o),
          (this.eo = n),
          (this.isOnEditable = this.makeIsOn($t.isEditable)),
          (this.isOnList = this.makeIsOn($t.isList)),
          (this.isOnAnchor = this.makeIsOn($t.isAnchor)),
          (this.isOnCell = this.makeIsOn($t.isCell)),
          (this.isOnData = this.makeIsOn($t.isData));
      }
      return (
        (r.prototype.nativeRange = function () {
          ...
          var e = Rt({ node: this.sc, offset: this.so });
          return (
            e.setEndPoint("EndToEnd", Rt({ node: this.ec, offset: this.eo })), e
          );
        }),
        ...
        (r.prototype.normalize = function () {
          var t = function (t, e) {
              if (
                $t.isVisiblePoint(t) &&
                (!$t.isEdgePoint(t) ||
                  ($t.isRightEdgePoint(t) && !e) ||
                  ($t.isLeftEdgePoint(t) && e) ||
                  ($t.isRightEdgePoint(t) &&
                    e &&
                    $t.isVoid(t.node.nextSibling)) ||
                  ($t.isLeftEdgePoint(t) &&
                    !e &&
                    $t.isVoid(t.node.previousSibling)) ||
                  ($t.isBlock(t.node) && $t.isEmpty(t.node)))
              )
                return t;
              var o = $t.ancestor(t.node, $t.isBlock);
              if (
                (($t.isLeftEdgePointOf(t, o) ||
                  $t.isVoid($t.prevPoint(t).node)) &&
                  !e) ||
                (($t.isRightEdgePointOf(t, o) ||
                  $t.isVoid($t.nextPoint(t).node)) &&
                  e)
              ) {
                if ($t.isVisiblePoint(t)) return t;
                e = !e;
              }
              return (
                (e
                  ? $t.nextPointUntil($t.nextPoint(t), $t.isVisiblePoint)
                  : $t.prevPointUntil($t.prevPoint(t), $t.isVisiblePoint)) || t
              );
            },
          ...
          return (
            $t.walkPoint(
              ...
              function (t) {
                ...
                $t.isEditable(t.node) ||
                  (i
                    ? ($t.isLeftEdgePoint(t) && a.push(t.node),
                      $t.isRightEdgePoint(t) &&
                        B.contains(a, t.node) &&
                        (e = t.node))
                    : (e = n ? $t.ancestor(t.node, o) : t.node),
                  e && o(e) && s.push(e));
              },
              !0
            ),
        ...
        (r.prototype.splitText = function () {
          ...
          return (
            $t.isText(this.ec) &&
              !$t.isEdgePoint(this.getEndPoint()) &&
              this.ec.splitText(this.eo),
            $t.isText(this.sc) &&
              !$t.isEdgePoint(this.getStartPoint()) &&
        ...
        (r.prototype.deleteContents = function () {
          ...
          return (
            C.each(e, function (t, e) {
              var o = e.parentNode;
              n.node !== o && 1 === $t.nodeLength(o) && i.push(o),
                $t.remove(e, !1);
            }),
        ...
        (r.prototype.wrapBodyInlineWithPara = function () {
          if ($t.isBodyContainer(this.sc) && $t.isEmpty(this.sc))
            return (
              (this.sc.innerHTML = $t.emptyPara),
          ...
          if ($t.isInline(e.sc)) {
            ...
            (t = B.last(o)),
              $t.isInline(t) || (t = o[o.length - 2] || e.sc.childNodes[e.so]);
          } else t = e.sc.childNodes[0 < e.so ? e.so - 1 : 0];
          var n = $t.listPrev(t, $t.isParaInline).reverse();
          if (
            (n = n.concat($t.listNext(t.nextSibling, $t.isParaInline))).length
          ) {
        ...
        (r.prototype.getWordRange = function (t) {
          ...
          return (
            t &&
              (e = $t.nextPointUntil(e, function (t) {
                return !$t.isCharPoint(t);
              })),
        ...
        (r.prototype.bookmark = function (t) {
          return {
            s: { path: $t.makeOffsetPath(t, this.sc), offset: this.so },
            e: { path: $t.makeOffsetPath(t, this.ec), offset: this.eo },
          };
        }),
    ...
    At = {
      create: function (t, e, o, n) {
        ...
        return i || 1 !== arguments.length
          ? i
          : (i = this.createFromNode(t)).collapse($t.emptyPara === t.innerHTML);
      },
      ...
      createFromNode: function (t) {
        var e = t,
          ...
          i = $t.nodeLength(n);
        return (
          $t.isVoid(e) && ((o = $t.listPrev(e).length - 1), (e = e.parentNode)),
          $t.isBR(n)
            ? ((i = $t.listPrev(n).length - 1), (n = n.parentNode))
            : $t.isVoid(n) && ((i = $t.listPrev(n).length), (n = n.parentNode)),
          this.create(e, o, n, i)
        );
      },
    ...
    Pt = {
      isEdit: function (t) {
        return B.contains(
          [Ft.BACKSPACE, Ft.TAB, Ft.ENTER, Ft.SPACE, Ft.DELETE],
          t
        );
      },
      isMove: function (t) {
      ...
      return (
        ...
        (t.prototype.applySnapshot = function (t) {
          null !== t.contents && this.$editable.html(t.contents),
            null !== t.bookmark &&
              At.createFromBookmark(this.editable, t.bookmark).select();
        }),
    ...
    Dt = (function () {
      ...
      return (
        ...
        (t.prototype.current = function (t) {
          ...
          return (
            (o.anchor = t.isOnAnchor() && $t.ancestor(t.sc, $t.isAnchor)),
            (o.ancestors = $t.listAncestor(t.sc, $t.isEditable)),
            (o.range = t),
            o
          );
        }),
      ...
      return (
        ...
        (t.prototype.toggleList = function (o, t) {
          ...
          if (B.find(i, $t.isPurePara)) {
            ...
            var l = e
              .nodes($t.isList, { includeAncestor: !0 })
              .filter(function (t) {
        ...
        (t.prototype.wrapList = function (t, e) {
          ...
          return (
            ...
            $t.appendChildNodes(s, t),
            r && ($t.appendChildNodes(s, B.from(r.childNodes)), $t.remove(r)),
            t
          );
        }),
              ...
              if ("LI" === i.parentNode.nodeName)
                ...
                var s =
                    1 < i.childNodes.length
                      ? $t.splitTree(
                          i,
                          { node: n.parentNode, offset: $t.position(n) + 1 },
                          { isSkipPaddingBlankHTML: !0 }
                        )
                      : null,
                  a = $t.splitTree(
                    i,
                    { node: o.parentNode, offset: $t.position(o) },
                    { isSkipPaddingBlankHTML: !0 }
                  );
                (e = c
                  ? $t.listDescendant(a, $t.isLi)
                  : B.from(a.childNodes).filter($t.isLi)),
                  (!c && $t.isList(i.parentNode)) ||
                    (e = e.map(function (t) {
        ...
        (t.prototype.appendToPrevious = function (t) {
          return t.previousSibling
            ? $t.appendChildNodes(t.previousSibling, [t])
            : this.wrapList([t], "LI");
        }),
        (t.prototype.findList = function (t) {
          return t
            ? B.find(t.children, function (t) {
      ...
      return (
        (t.prototype.insertTab = function (t, e) {
          ...
          (t = t.deleteContents()).insertNode(o, !0),
            (t = At.create(o, e)).select();
        }),
        (t.prototype.insertParagraph = function (t, e) {
          e = (e = (e =
            e || At.create(t)).deleteContents()).wrapBodyInlineWithPara();
          var o,
            n = $t.ancestor(e.sc, $t.isPara);
          if (n) {
            if ($t.isEmpty(n) && $t.isLi(n))
              return void this.bullet.toggleList(n.parentNode.nodeName);
            var i = null;
            if (
              (1 === this.options.blockquoteBreakingLevel
                ? (i = $t.ancestor(n, $t.isBlockquote))
                : 2 === this.options.blockquoteBreakingLevel &&
                  (i = $t.lastAncestor(n, $t.isBlockquote)),
              i)
            ) {
              (o = C($t.emptyPara)[0]),
                $t.isRightEdgePoint(e.getStartPoint()) &&
                  $t.isBR(e.sc.nextSibling) &&
                  C(e.sc.nextSibling).remove();
              ...
              (s = s.concat($t.listDescendant(o, $t.isEmptyAnchor))),
                C.each(s, function (t, e) {
                  $t.remove(e);
                }),
                ($t.isHeading(o) || $t.isPre(o) || $t.isCustomStyleTag(o)) &&
                  $t.isEmpty(o) &&
                  (o = $t.replace(o, "p"));
            }
          } else {
        ...
        (t.prototype.addCol = function (t, e) {
          ...
          for (
            ...
            switch (s.action) {
              case Mt.resultAction.AddCell:
                "right" === e
                  ? C(s.baseCell).after("<td" + a + ">" + $t.blank + "</td>")
                  : C(s.baseCell).before("<td" + a + ">" + $t.blank + "</td>");
                break;
              case Mt.resultAction.SumSpanCount:
                if ("right" === e) {
      ...
      function t(t) {
        ...
        (this.insertParagraph = this.wrapCommand(function () {
          ...
          (this.insertNode = this.wrapCommand(function (t) {
            u.isLimited(C(t).text().length) ||
              (u.getLastRange().insertNode(t),
              At.createFromNodeAfter(t).select(),
              u.setLastRange());
          })),
          ...
          (this.insertHorizontalRule = this.wrapCommand(function () {
            ...
            t.nextSibling &&
              (At.create(t.nextSibling, 0).normalize().select(),
              u.setLastRange());
          })),
          ...
          (this.createLink = this.wrapCommand(function (t) {
            ...
            if (!(0 < r && u.isLimited(r))) {
              ...
              "string" == typeof o && (o = o.trim()),
                (o = u.options.onCreateLink
                  ? u.options.onCreateLink(o)
                  : /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(o)
                  ? o
                  : "http://" + o);
              var a = [];
              if (s) {
      ...
      return (
        (t.prototype.initialize = function () {
          ...
          this.$editable
            ...
            this.$editable.html($t.html(this.$note) || $t.emptyPara),
            this.$editable.on(
              R.inputEventName,
              A.debounce(function () {
        ...
        (t.prototype.handleKeyMap = function (t) {
          ...
          i
            ...
            : Pt.isEdit(t.keyCode) && this.afterCommand();
        }),
        (t.prototype.preventDefaultEditableShortCuts = function (t) {
          (t.ctrlKey || t.metaKey) &&
            B.contains([66, 73, 85], t.keyCode) &&
            t.preventDefault();
        }),
          ...
          return (
            ...
            (void 0 === e ||
              !(
                ...
                e.ctrlKey ||
                e.metaKey ||
                B.contains([Pt.code.BACKSPACE, Pt.code.DELETE], e.keyCode)
              )) &&
          ...
          C.Deferred(function (t) {
            ...
            .then(function (t) {
              n.beforeCommand(),
                ...
                t.show(),
                At.create(n.editable).insertNode(t[0]),
                At.createFromNodeAfter(t[0]).select(),
                n.setLastRange(),
                n.afterCommand();
            })
            .fail(function (t) {
        ...
        (t.prototype.getSelectedText = function () {
          ...
          return (
            t.isOnAnchor() &&
              (t = At.createFromNode($t.ancestor(t.sc, $t.isAnchor))),
            t.toString()
          );
        }),
        ...
        (t.prototype.fontStyling = function (t, e) {
          ...
          if (o) {
            ...
            if ((C(n).css(t, e), o.isCollapsed())) {
              ...
              i &&
                !$t.nodeLength(i) &&
                ((i.innerHTML = $t.ZERO_WIDTH_NBSP_CHAR),
                At.createFromNodeAfter(i.firstChild).select(),
                this.setLastRange(),
        ...
        (t.prototype.isEmpty = function () {
          return (
            $t.isEmpty(this.$editable[0]) ||
            $t.emptyPara === this.$editable.html()
          );
        }),
  ...
  var qt = (function () {
      ...
      return (
        ...
        (t.prototype.activate = function () {
          ...
          if (
            (this.$codable.val(
              $t.html(this.$editable, this.options.prettifyHtml)
            ),
        ...
        (t.prototype.deactivate = function () {
          ...
          var e = this.purify(
              $t.value(this.$codable, this.options.prettifyHtml) || $t.emptyPara
            ),
        ...
        (t.prototype.update = function (t, e) {
          ...
          if ((this.context.invoke("imagePopover.update", t, e), o)) {
            var i = C(t),
              ...
              a = { w: i.outerWidth(!1), h: i.outerHeight(!1) };
            n.css({
              display: "block",
              left: s.left,
              top: s.top,
    ...
    Yt = (function () {
      ...
      return (
        ...
        (t.prototype.handleKeyup = function (t) {
          B.contains([Pt.code.ENTER, Pt.code.SPACE], t.keyCode) &&
            this.replace();
        }),
        t
      );
      ...
      return (
            ...
            this.options.match(t, function (t) {
              if (t) {
                ...
                if (
                  ...
                  return;
                o.lastWord.insertNode(e),
                  (o.lastWord = null),
                  o.context.invoke("editor.focus");
              }
            });
          }
        }),
        (t.prototype.handleKeydown = function (t) {
          if (
            ...
            B.contains(this.keys, this.previousKeydownCode)
          )
    ...
    Xt = (function () {
      ...
      return (
        ...
        (t.prototype.initialize = function () {
          var t = this;
          (this.$placeholder = C('<div class="note-placeholder">')),
            this.$placeholder
              .on("click", function () {
    ...
    te = (function () {
      function t(t) {
        (this.ui = C.summernote.ui),
          ...
          (this.options = t.options),
          (this.lang = this.options.langInfo),
          (this.invertedKeyMap = A.invertObject(
            this.options.keyMap[R.isMac ? "mac" : "pc"]
          ));
      }
      return (
        (t.prototype.representShortcut = function (t) {
          ...
          return this.options.shortcuts && e
            ? (R.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")),
              " (" +
                (e = e
                  .replace("BACKSLASH", "\\")
                  .replace("SLASH", "/")
          ...
          return (
            this.fontInstalledMap.hasOwnProperty(t) ||
              (this.fontInstalledMap[t] =
                R.isFontInstalled(t) ||
                B.contains(this.options.fontNamesIgnoreCheck, t)),
            this.fontInstalledMap[t]
          );
        }),
                ...
                this.button({
                  ...
                  callback: function (t) {
                    ...
                    o &&
                      (e.css(
                        "background-color",
                        p.options.colorButton.backColor
                      ),
                      t.attr(
                        "data-backColor",
                        p.options.colorButton.backColor
                      ...
                      n
                        ? (e.css("color", p.options.colorButton.foreColor),
                          t.attr(
                            "data-foreColor",
                            p.options.colorButton.foreColor
                          ))
        ...
        (t.prototype.addToolbarButtons = function () {
          ...
          this.context.memo("button.bold", function () {
            ...
            this.context.memo("button.fontname", function () {
              ...
              return (
                C.each(t["font-family"].split(","), function (t, e) {
                  (e = e.trim().replace(/['"]+/g, "")),
          ...
          this.context.memo("button.justifyLeft", A.invoke(r, "render")),
            this.context.memo("button.justifyCenter", A.invoke(s, "render")),
            this.context.memo("button.justifyRight", A.invoke(a, "render")),
            this.context.memo("button.justifyFull", A.invoke(l, "render")),
            this.context.memo("button.outdent", A.invoke(c, "render")),
            this.context.memo("button.indent", A.invoke(d, "render")),
      ...
      return (
        ...
        (t.prototype.followScroll = function () {
          ...
          this.options.otherStaticBar &&
            (i = C(this.options.otherStaticBar).outerHeight());
          var r = this.$document.scrollTop(),
            s = this.$editor.offset().top,
            a = s - i,
            l = s + t - i - o - n;
          !this.isFollowing && a < r && r < l - o
            ? ((this.isFollowing = !0),
              this.$toolbar.css({ position: "fixed", top: i, width: e }),
              this.$editable.css({ marginTop: this.$toolbar.height() + 5 }))
            : this.isFollowing &&
              (r < a || l < r) &&
              ((this.isFollowing = !1),
              this.$toolbar.css({
        ...
        (t.prototype.showLinkDialog = function (s) {
          ...
          return C.Deferred(function (e) {
            ...
            a.ui.onDialogShown(a.$dialog, function () {
              a.context.triggerEvent("dialog.shown"),
                !s.url && A.isValidUrl(s.text) && (s.url = s.text),
                o
                ...
                n
                  ...
                  .val(s.url),
                R.isSupportTouch || n.trigger("focus"),
                a.toggleLinkBtn(i, o, n),
                a.bindEnterKey(n, i),
                a.bindEnterKey(o, i);
              var t =
                void 0 !== s.isNewWindow
                  ? s.isNewWindow
                  : a.context.options.linkTargetBlank;
              r.prop("checked", t),
            ...
            i.ui.onDialogShown(i.$dialog, function () {
              i.context.triggerEvent("dialog.shown"),
                ...
                o
                  ...
                  .val(""),
                R.isSupportTouch || o.trigger("focus"),
                n.click(function (t) {
      ...
      return (
        ...
        (t.prototype.initialize = function () {
          ...
          this.context.invoke("buttons.build", t, this.options.popover.table),
            R.isFF && document.execCommand("enableInlineTableEditing", !1, !1);
        }),
        (t.prototype.destroy = function () {
          this.$popover.remove();
        }),
        ...
        (t.prototype.createVideoNode = function (t) {
          ...
          if (o && 11 === o[1].length) {
            ...
            if (void 0 !== o[2]) {
              ...
              if (g)
                for (var v = [3600, 60, 1], b = 0, y = v.length; b < y; b++)
            ...
            e = C("<iframe>")
              ...
              .attr(
                "src",
                "//www.youtube.com/embed/" + f + (0 < m ? "?start=" + m : "")
              )
              .attr("width", "640")
              .attr("height", "360");
            ...
            e = C(
              ...
              .attr(
                "src",
                "http://v.qq.com/iframe/player.html?vid=" + k + "&amp;auto=0"
              );
          } else if (d || u || h)
            e = C("<video controls>")
              .attr("src", t)
          ...
          return Object.keys(i)
            .map(function (t) {
              ...
              return (
                o
                  .append(
                    C("<label><kbd>" + t + "</kdb></label>").css({
                      width: 180,
                      "margin-right": 10,
                    })
                  )
                  .append(C("<span/>").html(n.context.memo("help." + e) || e)),
                o.html()
              );
            })
            .join("");
        ...
        (this.context = t),
          ...
          (this.events = {
            ...
            "summernote.focusout": function (t, e) {
              R.isFF ||
                (e.relatedTarget &&
                  $t.ancestor(e.relatedTarget, A.eq(o.$popover[0]))) ||
                o.hide();
            },
          });
      }
    ...
    de = (function () {
      ...
      return (
          ...
          (this.lastWordRange = null),
            ...
            this.$content.on("click", ".note-hint-item", function (t) {
              e.$content.find(".active").removeClass("active"),
                C(t.currentTarget).addClass("active"),
                e.replace();
            });
        }),
        (t.prototype.destroy = function () {
        ...
        (t.prototype.replace = function () {
          ...
          if (t.length) {
            ...
            this.lastWordRange.insertNode(e),
              At.createFromNode(e).collapse().select(),
              (this.lastWordRange = null),
              this.hide(),
              this.context.triggerEvent(
                "change",
        ...
        (t.prototype.handleKeydown = function (t) {
          this.$popover.is(":visible") &&
            (t.keyCode === Pt.code.ENTER
              ...
              : t.keyCode === Pt.code.UP
              ? (t.preventDefault(), this.moveUp())
              : t.keyCode === Pt.code.DOWN &&
        ...
        (t.prototype.handleKeyup = function (t) {
          var o = this;
          if (
            !B.contains([Pt.code.ENTER, Pt.code.UP, Pt.code.DOWN], t.keyCode)
          ) {
  ...
  (C.summernote = C.extend(C.summernote, {
    ...
    (C.summernote = C.extend(C.summernote, { ui: b })),
    (C.summernote.options.styleTags = [
      "p",
      {
        title: "Blockquote",
        tag: "blockquote",
