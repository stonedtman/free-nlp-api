package com.yqt.yqt.wordfilter;
...
public class WordContext {
    ...
    public WordContext(Iterable<String> blacks, Iterable<String> whites) {
        try {
                // 将敏感词库加入到HashMap中
                addWord(blacks, WordType.BLACK);
                // 将非敏感词库也加入到HashMap中
                addWord(whites, WordType.WHITE);
        } catch (Exception e) {
